...
// Zod schema kept for validating the AI's parsed response (not sent to Gemini directly)
...
`
    ...
    if (!result.success) {
        console.error("AI response failed validation:", result.error)
        throw new Error("AI failed to generate a complete report")
    }
